    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h3>
         <b>Carriage Inwards Data Entering..</b>
      </h3>
          <!-- general form elements -->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h5><b><i class="fa fa-info" style="color: red"></i> Carriage Inwards</b> : This is the shipping and handling costs incurred when receiving goods from suppliers.</h5>
            </div>
            <!-- /.box-header -->
            <!-- form start -->

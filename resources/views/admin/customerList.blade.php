  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-md-10">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title text-right"><b>Existing Customers</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="text-right">
                <a type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-success-customerForm">Add New Customer</a>
              </div>
              <hr>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>            
                    ...
                    <a type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success-profile">view</a>
                 </td>
                </tr>
      ...
      <!-- Modal for View Inventory Report -->
        <div class="modal fade" id="modal-success-profile">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header" style="background-color: darkcyan;">
                ...
                <h4 class="text-center" style="font-weight: bolder;">DARL DISTRIBUTORS NIG. LTD<br>Customer Profile</h4>
              </div>
              ...
              <div class="modal-footer" >
                <button style="background-color:darkred;" type="button" class="btn btn-outline" data-dismiss="modal">Close</button>
                <button style="background-color: darkcyan;" type="button" class="btn btn-outline" data-toggle="modal" data-target="#modal-success-edit">Edit</button>
              </div>
              </form>
              </div>
            </div>
      ...
      <!-- Modal for View Inventory Report -->
            ...
            <div class="modal-content">
              <div class="modal-header" style="background-color:darkcyan">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Editing Customer Profile</b></h4>
              </div>
              <div class="modal-body">
            ...
            <form  method="POST" action="#">
             ...
             <div class="row">
              <div class="modal-footer">
                ...
                <button style="background-color: blue;" type="button" class="btn btn-outline">Update</button>
              </div>
        ...
        <!-- Modal for View Inventory Report -->
          <div class="modal fade" id="modal-success-customerForm">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Customer Registration</b></h4>
              </div>
              <div class="modal-body">
          ...
          <!-- after form submission, there should be link to Sale Order Form: Form B -->
            <form  method="POST" action="#">
             ...
             <div class="row">
              <div class="modal-footer">
                <button style="background-color: darkred;" type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <button style="background-color: blue;" type="button" class="btn btn-outline">Register</button>
              </div>

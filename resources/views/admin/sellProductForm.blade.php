               ...
               <form role="form" method="POST" action="{{ route('sales.new') }}">
                    ...
                    <hr>
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <input type="text" id="customer_name" class="form-control" placeholder="Customer name" name="customer_name" minlength="1" maxlength="250" required>
                        </div>

                        <div class="col-md-6">
                          <label for="customer_phone">Customer phone<span style="color:red"> *</span></label>
                          <input type="test" id="customer_phone" class="form-control" placeholder="Customer phone" name="customer_phone" minlength="11" maxlength="11" required>
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="number" oninput="calculateGrandTotal()" id="discount"  class="form-control" placeholder="0" name="discount" min="0">
                        </div>

                        <div class="col-md-6">
                          <label for="debt">Balance for sales(debt)</label>
                          <input type="number" oninput="calculateGrandTotal()" id="debt"  class="form-control" placeholder="0" name="debt" min="0" >
                        </div>
                ...
                <tr>
                  <td class="text-center" colspan="5">
                    ...
                    <h3>TOTAL: #<span id="grand_total">{{$selectedProds::getProd($products, $_GET['items'] ?? '', true)}}</span></h3>

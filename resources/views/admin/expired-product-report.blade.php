        ...
        <div class="col-md-10">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <h3 class="box-title text-right"><b>Expired Product Report</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      <!-- Modal for View confirm Order  -->
       ...
       <table class="table">
                ...
                <tr>
                  ...
                  <td>30000</td>
                  <td>60000</td>
                  <td><span class="label label-success">Expired</span></td>
                </tr>
        ...
        <div class="modal fade" id="modal-success-edit">
         ...
         <form role="form" method="POST" action="newCustomerForm.php">
              <div class="box-footer">
                <b style="color: red"> Editing Expired Product Report</b>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Expiration Date<b style="color: red">*</b></label>
